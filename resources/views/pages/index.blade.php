									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											@if($item->discount_price == NULL)
												<div class="product_price discount">{{number_format($item->selling_price,0,',','.')}} đ</div>
											@else
												<div class="product_price discount">{{number_format($item->discount_price,0,',','.')}} đ</div>
												<div>
													<span class="old_price">{{number_format($item->selling_price,0,',','.')}} đ</span>
												</div>
											@endif
							...
							<div class="product_panel panel">
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($item->image_one)}}" alt="" style="width:120px;height:120px"></div>
											<div class="product_content">
												@if($item->discount_price == NULL)
													<div class="product_price discount">{{number_format($item->selling_price,0,',','.')}} đ</div>
												@else
