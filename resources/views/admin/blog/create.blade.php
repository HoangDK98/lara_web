    ...
    <div class="sl-mainpanel">
		...
		<div class="sl-pagebody">
			<div class="card pd-20 pd-sm-40">
				<h6 class="card-body-title">New Post Add Form
						...
						<div class="row mg-b-25">
							<div class="col-lg-4">
								<div class="form-group">
									...
									<input id="post_title_en" class="form-control" type="text" name="post_title_en" value="" placeholder="Post Title English : ">
								</div>
							</div><!-- col-4 -->
							<div class="col-lg-4">
								<div class="form-group">
									<label for="post_title_in" class="form-control-label">Post Title (Hindi) : <span class="tx-danger">*</span></label>
									<input id="post_title_in" class="form-control" type="text" name="post_title_in" value="" placeholder="Post Title Hindi : ">
								</div>
							</div><!-- col-4 -->
							<div class="col-lg-4">
                            ...
                            <div class="col-lg-12">
								<div class="form-group">
									...
									<textarea class="form-control" id="summernote1" name="detail_in"></textarea>
								</div>
							</div><!-- col-4 -->
							<div class="col-lg-4">
								<div class="form-group">
